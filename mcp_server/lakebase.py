...
Connects using a single LAKEBASE_URL (a standard Postgres connection URL, e.g.
...
This module provides helpers for reading weather query logs stored in Lakebase.
"""
